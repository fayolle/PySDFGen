...
// Assume that the input mesh is centered at the origin
// and normalized to the origin centered unit box 
pybind11::array_t<float>
compute_sdf_normalized(pybind11::array_t<float> V,
		       pybind11::array_t<unsigned int> F,
		       int res)
{
  std::vector<Vec3f> vert_list;
...
PYBIND11_MODULE(native, m) {
  ...
  m.def("compute_sdf_normalized", &compute_sdf_normalized, "Python wrapper to SDFGen");
}
